    ...
    <div className="result flex-col overflow-auto h-screen">
      ...
      <div className="flex flex-col justify-center items-center mt-6">
        ...
        <p className="leading-7 mt-6">
          ...
          ще відчуваєте дистрес, не соромтеся звертатися за допомогою. Пам'ятайте, що цей тест - це путівник, а не євангеліє - тільки фахівець може розставити всі крапки над "і" для повної картини. Якщо ваші стосунки з їжею та тілом не в порядку, незалежно від вашого балу, зверніться за професійною
          порадою. Завжди є час подбати про своє здоров'я
        </p>
