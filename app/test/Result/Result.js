  ...
  return (
    <div className='result-container'>
      ...
      <div className='result flex-col h-screen'>
        ...
        <div className='flex flex-col pl-9 pr-9 justify-center items-center mt-6'>
          {/*<p className='text-xl'>*/}
          ...
          <p className='leading-7 mt-6'>
            {testResult < 20 && (
              <>
                <b>Ваш результат <span className='font-bold text-xl'>{testResult}.</span></b> Причини для хвилювання немає за результатами тесту, у
                вас
