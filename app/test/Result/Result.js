      ...
      <div className='result flex-col h-screen'>
        ...
        <div className='flex flex-col pl-9 pr-9 justify-center items-center mt-6 text-result'>
          <p className='leading-7 mt-6'>
            {testResult < 20 && (
              <>
                <b><span className='font-bold text-xl'>Ваш результат {testResult} (максимальний результат 78), причини для хвилювання немає. За
            ...
            {testResult >= 20 && (
              <>
                <b><span className='font-bold text-xl'>Ваш результат {testResult} (максимальний результат 78), що свідчить про необхідність допомоги кваліфікованого
