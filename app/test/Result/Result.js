    ...
    <div className='result flex-col overflow-auto h-screen'>
      ...
      <div className='flex flex-col justify-center items-center mt-6'>
        ...
        <p className='leading-7 mt-6'>
          {testResult < 20 && (
            <>
              <b>Ваш результат <span className='font-bold text-xl'>{testResult}.</span></b> Причини для хвилювання немає за результатами тесту, у вас
              низька ймовірність розладу харчової поведінки.
              <br /><br />
          ...
          {testResult >= 20 && (
            <>
              <b><span className='font-bold text-xl'>Ваш результат {testResult}</span></b>, що свідчить про необхідність допомоги кваліфікованого
              спеціаліста.
              Розлад харчової поведінки є захворюванням, ознаки якого на перший погляд є не очевидними , але які суттєво впливають на якість життя.
              <br /><br />
              В наш час підтримка здорових стосунків із тілом та іжею має одне із першочергових значень
              Більше про перебіг захворювання та методи лікування ви зможете отримати в нашому закритому телеграм каналі.
              {/*Приєднатись*/}
            </>
          )}
          <a href='https://click.pulse.is/public/s/MjkwMTY=/p/MzQ4Nzg=/l/aHR0cHM6Ly90Lm1lLytSRk5RQWlieDdObERDVjZJ' className='block m-auto text-center'>
        ...
        <p className='mt-6' style={{ fontSize: '.7rem' }}>
          ...
          Eating Attitudes Test (Тест ставлення до їди, EAT26) був розроблений David M.Garner в Інституті психіатрії Кларка університету Торонто в
          1979 р.,
          <br /><br />
